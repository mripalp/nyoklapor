...
import { createAdminTemplate } from '../templates/template-creator';
...
const Admin = {
  ...
  async afterRender() {
    ...
    const jumlahLaporan = document.querySelector('#jumlahLaporan');
    ...
    jumlahLaporan.textContent = '100';
    document.getElementById('jumlahLaporan').textContent = '25';
    document.getElementById('rataLaporan').textContent = '25';
    ...
    // Tambahkan variabel untuk menyimpan status tampilan terakhir
  },
};
